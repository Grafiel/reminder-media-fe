    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-600 text-lg mb-8">
          Manage your media collection and discover new content.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Track your favorite films</p>
            </div>
          </NavLink>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Organize your music</p>
            </div>
          </NavLink>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Keep track of your games</p>
            </div>
          </NavLink>
        </div>
