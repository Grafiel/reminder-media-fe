...
export default function Movie({ id, title, director, description, releaseYear, posterUrl, genre }: MovieProps) {
  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-md">
      ...
      <div>
        {posterUrl && (
          <img src={posterUrl} alt={title} className="w-full h-48 object-cover rounded-md mb-4" />
        )}
        <div>
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-lg font-semibold mb-4">Are you sure you want to delete this movie?</h3>
      ...
      {isUpdateModalOpen && (
        <UpdateMovieModal
          movie={{ id, title, director, description, releaseYear, posterUrl, genre }}
...
function UpdateMovieModal({ movie, onClose }: UpdateMovieModalProps) {
  const queryClient = useQueryClient();
